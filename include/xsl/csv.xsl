...
/><xsl:text>&#x9;</xsl:text><xsl:value-of select="gmd:identificationInfo/*/gmd:citation/*/gmd:identifier" 
/><xsl:text>&#x9;</xsl:text><xsl:call-template name="multi">
	<xsl:with-param name="el" select="gmd:identificationInfo/*/gmd:citation/*/gmd:title"/>
	<xsl:with-param name="lang" select="'cze'"/>
	<xsl:with-param name="mdlang" select="$mdlang"/>
</xsl:call-template><xsl:text>&#x9;</xsl:text><xsl:call-template name="multi">
	<xsl:with-param name="el" select="gmd:identificationInfo/*/gmd:citation/*/gmd:title"/>
...
/><xsl:text>&#x9;</xsl:text><xsl:choose>
	...
	<xsl:when test="contains($inspire, 'INSPIRE')">Ano</xsl:when>
