  ...
  <xsl:template match="wfs:WFS_Capabilities"
   ...
   <!--<xsl:for-each select="//wfs:FeatureType">
    ...
    <MD_Distribution>
  	...
  	<!--referencni system-->
  	<xsl:for-each select="//wfs:FeatureType/wfs:DefaultCRS|//wfs:FeatureType/wfs:OtherCRS">
  	<referenceSystemInfo>
  	  <MD_ReferenceSystem>
  	  <referenceSystemIdentifier>
  	  	<RS_Identifier>
  	  	  <code><xsl:call-template name="GetLastSegment">
  	  	  	<xsl:with-param name="value" select="."/>
  	  	  </xsl:call-template></code>
  		  <codeSpace><xsl:call-template name="GetBeforeLastSegment">
  	  	  	<xsl:with-param name="value" select="."/>
  	  	  </xsl:call-template></codeSpace>
  		</RS_Identifier>
  	  </referenceSystemIdentifier>
  	  </MD_ReferenceSystem>
  	</referenceSystemInfo>	 
